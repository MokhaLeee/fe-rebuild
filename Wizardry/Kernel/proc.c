...
static EWRAM_DATA struct ProcDummy sProcArray[PROC_COUNT];
static EWRAM_DATA struct ProcDummy *sProcAllocList[PROC_COUNT + 1];
static EWRAM_DATA struct ProcDummy **sProcAllocListHead;

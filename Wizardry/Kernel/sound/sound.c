...
struct ProcScr const ProcScr_MusicFadeIn[] =
{
    PROC_NAME("MusicFadeIn"),
    PROC_END_DUPS,
    PROC_REPEAT(MusicFi_OnLoop),
    PROC_END,
};

struct ProcScr const ProcScr_MusicVolChange[] =
{
    PROC_NAME("MusicVolChange"),
    PROC_REPEAT(MusicVc_OnLoop),
    PROC_END,
};

struct ProcScr const ProcScr_DelaySong[] =
{
    PROC_NAME("DelaySong"),

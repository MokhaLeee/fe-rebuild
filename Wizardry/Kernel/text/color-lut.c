...
#define COLOR_CONVERT(pixel) ((pixel == 0) ?  4 : \
                              ...
                              (pixel == 3) ? 15 : \
                              0)
u16 CONST_DATA TextColorLut_47CF[] = { GENERATE_LOOKUP_TABLE };
#undef COLOR_CONVERT

#define COLOR_CONVERT(pixel) ((pixel == 0) ? 15 : 0)
u16 CONST_DATA TextColorLut_InverseMask[] = { GENERATE_LOOKUP_TABLE };
#undef COLOR_CONVERT
